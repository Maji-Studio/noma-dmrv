...
describe("buildCreateDatapointRequest scope-conflict SafeError", () => {
  ...
  const minimalAgg: AggregatedProductionData = {
    ...
    feedstockTransportAvgDistanceKm: 0,
    biocharTransportAvgDistanceKm: 0,
    sampleTransportAvgDistanceKm: 0,
    sampleTransportMassDistanceTonneKm: 0,
    biomassElectricityKwh: 0,
    pyrolysisElectricityKwh: 0,
    biocharElectricityKwh: 0,
    biomassGensetKwh: 0,
    pyrolysisGensetKwh: 0,
    biocharGensetKwh: 0,
