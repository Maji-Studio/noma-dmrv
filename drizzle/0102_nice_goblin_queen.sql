...
CREATE INDEX "deliveries_organization_id_order_id_delivery_date_idx" ON "deliveries" USING btree ("organization_id","order_id","delivery_date");--> statement-breakpoint
CREATE INDEX "production_run_feedstocks_organization_id_idx" ON "production_run_feedstocks" USING btree ("organization_id","production_run_id");--> statement-breakpoint
CREATE INDEX "biochar_product_source_allocations_organization_id_idx" ON "biochar_product_source_allocations" USING btree ("organization_id","production_run_id");