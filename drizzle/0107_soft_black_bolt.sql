...
CREATE TABLE "certifier_storage_locations" (
	...
	CONSTRAINT "certifier_storage_locations_provider_customer_location_unique" UNIQUE("provider","customer_location_id"),
...
CREATE UNIQUE INDEX "customer_locations_id_organization_id_unique" ON "customer_locations" USING btree ("id","organization_id");--> statement-breakpoint
