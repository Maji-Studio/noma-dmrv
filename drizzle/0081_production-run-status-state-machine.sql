...
ALTER TABLE "production_runs" ADD CONSTRAINT "production_runs_cancelled_requires_reason" CHECK ("production_runs"."status" <> 'cancelled' or length(trim("production_runs"."cancellation_reason")) > 0);
