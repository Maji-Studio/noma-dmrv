...
--> statement-breakpoint
CREATE TYPE "public"."credit_batch_sampling" AS ENUM('sampled', 'unsampled');--> statement-breakpoint
ALTER TABLE "production_processes" DROP CONSTRAINT "production_processes_method_b_prereqs_chk";--> statement-breakpoint
ALTER TABLE "credit_batches" ADD COLUMN "sampling" "credit_batch_sampling" DEFAULT 'sampled' NOT NULL;--> statement-breakpoint
ALTER TABLE "feedstock_types" ADD COLUMN "isometric_feedstock_type_id" text;--> statement-breakpoint
ALTER TABLE "feedstock_types" ADD COLUMN "archived_at" timestamp;--> statement-breakpoint
ALTER TABLE "production_processes" DROP COLUMN "sampling_method";--> statement-breakpoint
ALTER TABLE "production_processes" DROP COLUMN "method_b_unlocked_at";--> statement-breakpoint
ALTER TABLE "feedstock_types" ADD CONSTRAINT "feedstock_types_organization_id_isometric_id_unique" UNIQUE("organization_id","isometric_feedstock_type_id");--> statement-breakpoint
