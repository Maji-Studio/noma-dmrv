...
CREATE INDEX "biochar_product_source_allocations_organization_id_production_run_id_idx" ON "biochar_product_source_allocations" USING btree ("organization_id","production_run_id");--> statement-breakpoint
