...
- Product creation establishes source dry biochar and ingredient dry solids. Ingredient moisture is prefilled from the oldest intake and can be overridden; the actual value used is retained. Pre-blend dry biochar remains the ceiling, independent of subsequent moisture changes.
