<!--
ARCHIVED — dated snapshot. Archived 2026-06-08.
Status: archived (plan executed — Tier-2 entity-readiness registry + removal of
the dead `delivery` transport-leg path shipped). Original owner: unassigned
handoff. Historical implementation/design log; any remaining active decisions
