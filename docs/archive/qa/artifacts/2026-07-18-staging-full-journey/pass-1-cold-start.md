...
Admin role, staging. Visited 27 static/legacy routes from the 33-route inventory. Supplier/customer/credit-batch dynamic detail behavior was partially exercised with authorized visible IDs; legacy certification dynamic redirects were not exercised.
