...
| Missing supplier/customer IDs | P2 | Missing detail IDs retry for roughly seven seconds and then show a generic error instead of a proper not-found state. | Reproduced; the large stale detail-route branch was not merged wholesale. |
