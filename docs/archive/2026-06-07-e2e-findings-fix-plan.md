<!--
ARCHIVED — dated snapshot of a 2026-06-06 manual E2E walkthrough. Archived
2026-06-08. Status: archived (P0/P1/P2 items fixed; P3 product decisions tracked
in docs/open-questions.md). Stable decisions/sequencing summarized in the
evergreen pointer that referenced this file. Historical execution log.
-->
