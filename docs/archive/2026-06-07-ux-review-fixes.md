<!--
ARCHIVED — dated snapshot of a 2026-06-07 UX review walkthrough. Archived
2026-06-08. Status: archived (12 items done, 1 partial, 6 still open). The
still-open items are carried forward in the evergreen pointer that referenced
this file. Historical execution log.
-->
