  ...
  const hint =
    defaultUsage === "blend"
      ...
      : defaultUsage === "pyrolysis"
        ...
        : "Choose Pyrolysis for production inputs or Blend for formulation materials. Blend feedstock types are internal-only and are not submitted to the registry.";
