...
function MatchingOutputBinCard({ bin, facilityId, physicalDate }: {
  ...
  return <div className="space-y-12">
    ...
    <div id={detailsId} hidden={!detailsOpen} className="space-y-12 border-t border-[var(--color-border-secondary)] pt-16 body-caption">
      ...
      <div className="flex items-center gap-8">Delivered from the oldest lot first<InfoHint label="About FIFO">At delivery, stock placed by the movement date is used oldest first, then by posting order. Dry biochar excludes ingredient solids and water. Creating an order does not draw from these lots.</InfoHint></div>
