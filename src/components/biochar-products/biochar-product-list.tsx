...
import { ProductReadDetails } from "./product-read-details";
  ...
  return (
    <div className="container-max page-shell">
      ...
      <EntitySideSheet
        ...
        viewModeChildren={viewedEntity ? <ProductReadDetails key={viewedEntity.id} product={viewedEntity} /> : undefined}
      >
        <BiocharProductForm
