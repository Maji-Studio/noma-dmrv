  ...
  await tx.insert(schema.creditBatches).values([
    {
      ...
      facilityId: ids.facilityMoshi,
      status: 'pending',
      startDate: demoTimestamps.creditBatch1Start,
      endDate: demoTimestamps.creditBatch1End,
      certifier: 'isometric',
    ...
    },
    {
      ...
      facilityId: ids.facilityMoshi,
      status: 'draft',
      startDate: demoTimestamps.creditBatch2Start,
      endDate: demoTimestamps.creditBatch2End,
      certifier: 'isometric',
      registry: 'Isometric Registry',
